                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        {companies.length > 0 && (
                            <Select onValueChange={selectChangeHandler}>
                                ...
                                <SelectContent className="bg-white/15 shadow-xl backdrop-blur-[2.4px] rounded-b-xl">
                                    <SelectGroup >
                                        {companies.map((company) => (
                                            <SelectItem className="cursor-pointer" key={company._id} value={company.name.toLowerCase()}>
                                                {company.name}
                                            </SelectItem>
                                        ))}
                                    </SelectGroup>
